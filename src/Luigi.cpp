...
void Luigi::right(int speed, float angle){
...
void Luigi::left(int speed, float angle){
...
void Luigi::rightForward(int speed){
...
void Luigi::leftForward(int speed){
    digitalWrite(STBY, HIGH);
